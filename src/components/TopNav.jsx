    ...
    <div className="max-w-[1520] mx-auto flex justify-between items-center p-4">
      <div className="flex items-center">
        ...
        <h1 className="text-2xl sm:text-3xl lg:text-4xl px-2">
          Yum<span className="font-bold">Eat</span>
        </h1>
      ...
      <button className="bg-orange-700 text-white hidden md:flex items-center p-2 rounded-full border border-black  px5 py-1">
